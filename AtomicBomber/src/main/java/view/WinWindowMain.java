...
public class WinWindowMain extends Application {
    private int kills;
    private int score;
    ...
    public WinWindowMain(Pane pane, InformationOfGame informationOfGame) {
        this.pane = pane;
    ...
    public void start(Stage primaryStage) throws Exception {
        URL url = WinMenu.class.getResource("/FXML/WinMenu.fxml");
